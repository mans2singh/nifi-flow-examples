...
#### 2.2.2 From the NIFI UI - import template `FileNeo4JExecutorTemplate.xml` from directory `neo4j-nifi-template`
...
#### 2.2.6 Start all the processors and check/resolve any error
#### 2.2.7 Copy create-node.cyp file from `neo4j-input-example` directory to the GetFile input directory
#### 2.2.8 Check the results in the cypher shell using the command 
`match (n) return *;`
